...
\begin{document}
\title{Clasificación de lesiones cutáneas mediante DeepLearning con YOLO}
...
\caption{Mapa de calor comparativo del rendimiento (mAP50) de los tres modelos por clase. Los colores más cálidos (rojo-amarillo) indican mejor rendimiento.}
